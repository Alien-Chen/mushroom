  ...
  <c-layout>
    <c-main>
      ...
      >
        <c-magazine
          ...
          <c-single-center pb10>
            <span mr7 font-tertiary fz20 font-feichi>
              今日必抢
            </span>
            ...
            >
              <c-box-skin radius4>
                ...
                <c-single-center pb10>
                  ...
                  <c-box-center class="good__buy" circle>
                    抢
                  </c-box-center>
                </c-single-center>
              </c-box-skin>
      ...
      <c-box-center class="count">
        ...
        <c-box-center 
          class="count__time"
          bga10 radius2>{{hour}}</c-box-center>
        <span ph4>:</span>
        <c-box-center 
          class="count__time"
          bga10 radius2>{{min}}</c-box-center >
        <span ph4>:</span>
        <c-box-center  
          class="count__time"
          bga10 radius2>{{second}}</c-box-center>
        <span p9>——</span>
      </c-box-center>
